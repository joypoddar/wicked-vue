<template>
  ...
  <footer class="mt-10 text-gray-700 bg-white border-t body-font">
    <div class="border-t border-gray-200">
      ...
      >
        <a
          class="flex items-center w-48 mb-4 font-medium text-gray-900 title-font md:mb-0"
        >
        ...
        >
          <a
            href="#"
            class="justify-center mr-5 text-sm text-center text-gray-600 hover:text-gray-800"
          >
            Prices</a
          >
          <a
      ...
      >
        <p class="text-sm text-center text-gray-200">© Your Company — 2020</p>
      </div>
    </div>
  </footer>
</template>
