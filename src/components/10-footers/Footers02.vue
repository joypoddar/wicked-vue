<template>
  <div
    class="container w-full p-20 m-4 mx-auto mt-6 text-center bg-white border-2 border-dashed h-80 border-blueGray-300 rounded-xl"
  >
    <p
  ...
  <footer class="mt-10 text-gray-700 bg-white border-t body-font">
    ...
    >
      <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
        ...
        <p class="mt-6 text-xs text-center text-gray-600">
          Wicked Templates helps you jumpstart a landing page by providing you
          with swapable sections.
        </p>
      </div>
      <div
      ...
      >
        <div class="w-full px-4 lg:w-1/3 md:w-1/2">
          <h1
            class="mb-3 text-sm font-medium tracking-widest text-blue-700 uppercase title-font"
          >
            Product
          </h1>
        ...
        <div class="w-full px-4 lg:w-1/3 md:w-1/2">
          <h1
            class="mb-3 text-sm font-semibold tracking-widest text-blue-800 uppercase title-font"
          >
            Contact
          </h1>
          <div class="flex">
            <button
              class="inline-flex w-full px-4 py-2 font-semibold text-white transition duration-500 ease-in-out transform rounded-lg shadow-xl bg-gradient-to-r from-blue-700 hover:from-blue-600 to-blue-600 hover:to-blue-700 focus:ring focus:outline-none"
            >
              Action
              <svg
                fill="none"
    ...
    <div class="bg-blueGray-900">
      <div
        class="container flex flex-col flex-wrap px-5 py-6 mx-auto sm:flex-row"
      >
