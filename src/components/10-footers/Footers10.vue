<template>
  <div
    class="container w-full p-20 m-4 mx-auto mt-8 text-center bg-white border-2 border-dashed h-72 border-blueGray-300 rounded-xl"
  >
    <p
      class="mt-auto italic tracking-tighter text-md text-blueGray-500 title-font"
    >
      -- Content goes here --
    </p>
  </div>
  <footer class="mt-12 text-gray-700 bg-white border-t body-font">
    <div
      class="container flex flex-col flex-wrap p-5 mx-auto md:items-center lg:items-start md:flex-row"
    >
      <div class="flex-shrink-0 w-48 mx-auto text-center md:mx-0 md:text-left">
        ...
        <p class="mt-4 text-xs text-center text-gray-600">
          WickedTemplates helps you jumpstart a landing page by providing you
      ...
      >
        ...
        <div class="w-full md:w-1/2 lg:pl-20">
          <h1
            class="mb-3 text-sm font-semibold tracking-widest text-blue-700 uppercase title-font"
          >
            Contact
          </h1>
