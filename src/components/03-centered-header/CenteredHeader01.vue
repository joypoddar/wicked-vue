<template>
  ...
  <section class="block" id="section">
    <div
      class="container flex flex-col items-center justify-center px-10 py-2 mx-auto lg:px-48"
    >
      <img
        class="object-cover object-center mx-auto mb-10 rounded-lg lg:w-full md:w-15/5 w-20/6"
        alt="hero"
