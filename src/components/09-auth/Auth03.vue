        ...
        <div class="flex w-full rounded-lg xl:w-3/4 lg:w-11/12 lg:shadow-xl">
          ...
          >
            <div class="relative z-10 m-12 text-left">
              <a
                class="flex items-center w-32 font-medium text-gray-900 title-font md:mb-6"
              >
              ...
              >
                ...
                one that you do not need for that project and paste the one you
                need in that moment. All the section have been given the same
                left/right padding. Because consistence is king.
              </div>
            </div>
          </div>
          <div
