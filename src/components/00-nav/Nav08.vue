  ...
  <body>
    <header class="text-gray-700 bg-white border-t border-b body-font">
      ...
      >
        ...
        <button
          class="p-1 ml-auto text-gray-400 bg-gray-800 rounded-full hover:text-white focus:outline-none focus:ring"
        >
    ...
    <header class="text-gray-700 border-t border-b body-font">
      ...
      >
        <nav class="flex flex-wrap items-center justify-center ml-4 text-base">
          <a
            href="#"
            class="mr-5 text-sm text-gray-700 rounded-xl hover:text-gray-800"
            >Dashboard</a
          >
          <a
            href="#"
