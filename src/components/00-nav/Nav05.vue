  ...
  <div>
    <header class="text-gray-700 bg-white border-t border-b body-font">
      ...
      >
        ...
        <button
          class="items-center px-8 py-3 mt-4 ml-auto font-semibold text-blue-700 transition duration-500 ease-in-out transform bg-white border rounded-lg lg:inline-flex lg:mt-px hover:border-blue-800 hover:bg-blue-700 hover:text-white focus:ring focus:outline-none"
        >
          Button
        </button>
      </div>
