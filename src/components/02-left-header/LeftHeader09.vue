    ...
    >
      ...
      >
        ...
        <div class="flex flex-wrap -mx-4 -mt-4 -mb-10 sm:-m-4">
          <div
            class="flex flex-col items-center p-4 mb-6 text-center md:w-1/2 md:mb-0 lg:text-left lg:items-start"
          >
            <div class="flex-grow">
              <h1
                class="flex mb-4 text-5xl font-normal leading-none text-blue-700"
              >
                <span>100</span>
                <span class="mt-auto ml-1 text-lg font-normal text-gray-500">
                  PX
                </span>
              </h1>
